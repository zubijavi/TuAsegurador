...
const Hero = () => {
    ...
    return (
        <main className="relative min-h-[70vh] md:min-h-[60vh] w-full flex items-center py-6 overflow-hidden">
            ...
            {/* Content */}
            <div
                className={`relative z-10 w-full px-6 lg:px-32 max-w-7xl transition-all duration-700 ${fade ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                    }`}
            >
          ...
          {slides[current].badge}
                ...
                <h2 className="text-2xl md:text-2xl text-white leading-tight mb-6">
                ...
                <div className="flex gap-4">
                    <button className="min-w-30 h-10 bg-white/10 border border-white/20 text-white rounded-lg font-bold hover:bg-white/20 transition">
                        {slides[current].button}
                    </button>
               
                    <button className="flex items-center justify-center min-w-30 h-10 bg-primary text-white font-bold shadow-lg shadow-primary/60 hover:shadow-primary/40 transition-all hover:-translate-y-1">
                        Más Info
                    </button>
